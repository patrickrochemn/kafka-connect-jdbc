...
public class MetisJdbcSinkTaskTest extends EasyMockSupport {
  private final SqliteHelper sqliteHelper = new SqliteHelper(getClass().getSimpleName());
  private final MetisJdbcDbWriter mockWriter = createMock(MetisJdbcDbWriter.class);
  ...
  public void testGetAllMessagesExceptionWithoutTrim() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    ...
    Method privateMethod = MetisJdbcSinkTask.class.getDeclaredMethod("getAllMessagesException", SQLException.class);
